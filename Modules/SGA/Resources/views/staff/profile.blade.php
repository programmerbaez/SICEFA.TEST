                ...
                <div class="profile-card">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="personal" role="tabpanel">
                            ...
                            <form action="{{ route('sga.staff.profile.update-personal-info') }}" method="POST" id="personalInfoForm">
                                @csrf
                                @method('PUT')
                        ...
                        <div class="tab-pane fade" id="security" role="tabpanel">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-8">
                                    ...
                                    <form action="{{ route('sga.staff.profile.change-password') }}" method="POST" id="changePasswordForm">
                                        @csrf
                                        @method('PUT')
